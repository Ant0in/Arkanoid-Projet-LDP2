...
std::tuple<float, float> Position2D::coords() {
...
const std::unordered_map<int, Action> DEFAULT_CONFIG{
    ...
    {static_cast<int>(ALLEGRO_KEY_ENTER), Action::REMAKE}};
...
const std::unordered_map<int, int> BRICK_VALUE{{static_cast<int>(BrickType::WHITE), 50},
...
const std::unordered_map<int, BrickType> BRICK_ID{{1, BrickType::WHITE},
                                                  {2, BrickType::ORANGE},
                                                  {3, BrickType::CYAN},
                                                  {4, BrickType::GREEN},
                                                  {5, BrickType::RED},
...
const float         SLOW_FACTOR             = 5.0f;
const float         RECOVERY_RATE           = 0.09f;
