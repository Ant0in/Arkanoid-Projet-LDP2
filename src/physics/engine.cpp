...
const void GameEngine::handleBricks(GameBox& gamebox, const Player& player, const std::vector<Brick>& bricks){
    for (Brick& brick : gamebox.getBricks()){
        ...
        if (brick.isBroken()){
            ...
            // TODO CHANGER BRIQUE SI NECESSAIRE
...
const void GameEngine::handleBallSpawn(GameBox& gamebox){
    // TODO FAIRE BELLE FONCTION DE SPAWN
    // TODO GERER PROPREMENT REMISE DE BALLE EN JEU
